					...
					<div class="card-body">
						...
						<form action="/editpost/{{$postedit->id}}/edit" method="POST" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<input class="upload form-control" type="text" name="post_title" value="{{$postedit->posttitle}}">
							</div>
							<div class="form-group">
								<label for="post_description">Description</label>
								<textarea class="upload form-control" type="text" name="post_description" value="" rows="4">{{$postedit->postdescription}}</textarea>
							</div>
							<div class="form-group">
